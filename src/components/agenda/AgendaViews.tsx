...
import { Clock, Gavel, ListTodo } from "lucide-react";
...
// ── Month View ──
export function MonthView({ selectedDate, onDayClick, typeFilter, assignmentFilter, companyFilter, currentUser, userRole }: {
...
// ── Week View ──
export function WeekView({ selectedDate, typeFilter, assignmentFilter, companyFilter, onEventClick, currentUser, userRole }: {
...
// ── Day View ──
export function DayView({ selectedDate, typeFilter, assignmentFilter, companyFilter, onEventClick, currentUser, userRole }: {
...
// ── Year View ──
export function YearView({ selectedDate, onMonthClick, typeFilter, assignmentFilter, companyFilter, currentUser, userRole }: {
